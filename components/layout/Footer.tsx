        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-text-secondary text-sm font-dm leading-relaxed mb-6">
              ...
              Capturing your most cherished moments with cinematic artistry.
            </p>
            {/* Social Icons */}
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-11 h-11 rounded-full bg-bg-card border border-border flex items-center justify-center text-text-secondary hover:text-accent hover:border-accent transition-all duration-300"
            ...
            <ul className="space-y-3">
              {footerLinks.services.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-text-secondary text-sm font-dm hover:text-accent transition-colors min-h-[44px] inline-flex items-center"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 inline-flex items-center gap-2 px-5 py-3 min-h-[44px] bg-[#25D366] hover:bg-[#20BD5A] text-white font-dm font-medium text-sm rounded-btn transition-all duration-300"
            >
